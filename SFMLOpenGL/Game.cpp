...
void Game::initialize()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(VBOVertices) * 7, vertex, GL_STATIC_DRAW);
...
void Game::render()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(VBOVertices) * 3, vertex, GL_STATIC_DRAW);
	...
	glVertexAttribPointer(positionID, 3, GL_FLOAT, GL_FALSE, sizeof(VBOVertices), 0);
	glVertexAttribPointer(colorID, 4, GL_FLOAT, GL_FALSE, sizeof(VBOVertices), 0);
